...
import Component2 from './compnents/Component2.js';
import Component3 from './compnents/Component3.js';
import Component1 from './compnents/Component1.js';
import Component4 from './compnents/Component4.js';
import './App.css';
...
<div id="content">
    ...
    <nav className="navbar navbar-expand navbar-light ">
        ...
        <button type="button" id="sidebarCollapse" class="btn mt-n2">
                ...
                <a href="/#" className="heading home mr-auto"><h2>Orders</h2></a>
                <div>
  ...
  <div className="container-fluid mb-5">
    <div className="row ml-md-2">
                <div className="col-12 onlineorders py-3">
                  Create billing
                  </div>
                  ...
                  <div className=" col-lg-6 col-xl-4 col-12" >
                    <Component2 name="Abhinash Bora" number="BM234345" money="456"/>
                  </div>
                  <div className=" col-lg-6 col-xl-4 col-12">
                    <Component2 name="Abhinash Bora" number="BM234345" money="456"/>
                  </div>
                  ...
                  <div className="col-12 onlineorders py-3 mt-4">
                    Order Progress
                  </div>
                  <div className="col-lg-6 col-xl-4 col-12">
                    <Component1 name="Arabinndo Ray" number="20 items in cart" money="2544" name1="Online order"/>
                  </div>
                  <div className="col-lg-6 col-xl-4 col-12">
                    <Component1 name="Arabinndo Ray" number="20 items in cart" money="1222" name1="Shop pickup"/>
                  </div>
                  <div className="col-lg-6 col-xl-4 col-12">
                    <Component1 name="Arabinndo Ray" number="20 items in cart" money="1100" name1="On Shop"/>
                  </div>
                  <div className="w-100"></div>
                  <div className="col-lg-6 col-12 mt-5">
                    <div className="card cardborder color1">
                      <div className="row px-4 py-2">
                        <div className="col-11 font36 pt-2">
                          Today's Order
                        </div>
                        <div className="col-1 mt-2 ml-n2">
                        ...
                        <br/>
                        <br/><br/><br/>
                        <div className="col-9 font15 pt-2">
                          <div>Total Customers served</div>
                        </div>
                        <div className="col-3 text-right">
                          <div>
                            <c className="font21">1222</c>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="col-lg-6 col-12 mt-5">
                    <div className="card cardborder color2">
                      <div className="row px-4 py-2">
                        <div className="col-11 font36 pt-2">
                          Meds Sold
                        </div>
                  ...
                  <div className="col-md-4 col-12 col-sm-6 mt-5">
                    <Component3 name="Today’s customers"></Component3>
                  </div>
                  <div className="col-md-4 col-12 col-sm-6 mt-5">
                    <Component3 name="Today’s customers"></Component3>
                  </div>
