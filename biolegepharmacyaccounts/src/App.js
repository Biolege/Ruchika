  ...
  <div className="container-fluid mb-5">
    <div className="row ml-md-2 mt-4">
                  <div className="col-lg-6 col-12">
                    <AccComp name="Total purchase" message="Check your overall purchases"></AccComp>
                  </div>
                  <div className="col-lg-6 col-12">
                    <AccComp name="Total sales" message="Check your sales"></AccComp>
                  </div>
                  <div className="col-lg-6 col-12 mt-lg-5">
                     <AccComp name="Payment to biolege meds" message="Track your payment with biolege meds"></AccComp>
                  </div>
                  <div className="col-lg-6 col-12 mt-lg-5">
                     <AccComp name="Payment to other distributers" message="Track your payments with other distributors"></AccComp>
                  </div>
              </div>
            </div>
