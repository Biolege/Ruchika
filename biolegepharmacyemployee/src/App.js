  ...
  <div className="container-fluid mb-5">
    <div className="row ml-md-2">
                  ...
                  <div className=" col-lg-6 col-xl-4 col-12" >
                    <Present name="Employee 1 Name" position="Pharmacist"number="12"></Present>
                  </div>
                  <div className=" col-lg-6 col-xl-4 col-12">
                  <Present name="Employee 1 Name" position="Pharmacist"number="12"></Present>
                  </div>
                  ...
                  <div className=" col-lg-6 col-xl-4 col-12 mt-xl-5">
                  <Present name="Employee 1 Name" position="Pharmacist"number="12"></Present>
                  </div>
                  <div class="w-100"></div>
                  ...
                  <div className="col-lg-6 col-12">
                    <Analytics name="Attendance report" message="Track your employee attendance"></Analytics>
                  </div>
                  <div className="col-lg-6 col-12">
                    <Analytics name="Checkout by" message="Track the employee checkout status"></Analytics>
                  </div>
                  <div className="col-lg-6 col-12 mt-lg-5">
                  <Analytics name="Employee salary and incentives" message="Maintain your employee salary"></Analytics>
                  </div>
              </div>
            </div>
